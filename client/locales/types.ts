...
export interface TranslationResource {
  ...
  ui: {
    ...
    peerjsServerPlaceholder: string;
    signalingServerSettings: string;
    signalingServerDesc: string;
    ...
    trysteroTrackersDesc: string;
    trysteroDisabled: string;
    defaultServers: string;
    serverLabelPrimary: string;
    serverLabelSecondary: string;
    serverLabelTertiary: string;
    peerToPeer: string;
