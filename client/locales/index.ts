...
const enUI = {
  ...
  signalingServerSettings: 'Signaling Server',
  signalingServerDesc: 'Manage custom signaling servers for WebRTC P2P connections',
  customServers: 'Custom Servers',
  addServer: 'Add Server',
  addServerPlaceholder: 'https://your-server.com/peerjs',
  noCustomServers: 'No custom servers added',
  ...
  trysteroTrackersDesc: 'Use BitTorrent trackers as alternative connection method',
  trysteroDisabled: 'Trystero disabled',
  defaultServers: 'Default Servers',
  serverLabelPrimary: 'Primary',
  serverLabelSecondary: 'Secondary',
  serverLabelTertiary: 'Tertiary',
  peerToPeer: 'Peer-to-Peer',
  directConnection: 'Direct connection between browsers',
  hostGame: 'New Game',
  hostGameDesc: 'Create a new game using WebRTC - no central server needed',
  copyHostLink: 'Copy Host Link',
  hostLinkCopied: 'Host link copied!',
  joinAsGuest: 'Join Game (P2P)',
  enterHostId: 'Enter Host ID or link',
  invalidHostId: 'Invalid Host ID',
  ...
  noLogsYet: 'No game actions logged yet.',
  ...
  backward: 'Backward',
  restore: 'Restore',
  restoreToSelected: 'Restore to selected',
