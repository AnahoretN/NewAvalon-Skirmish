    ...
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
      <div className="bg-gray-800 rounded-vu-2 p-8 shadow-xl w-full max-w-xl">
        <div className="space-y-9">
          ...
          {/* Collapsible Server Settings Container - ALWAYS DISABLED (Server Mode under development) */}
          <div className="rounded-vu-2 bg-gray-800 opacity-50 cursor-not-allowed">
            <button
              disabled
              className="w-full flex items-center justify-between p-3 text-left cursor-not-allowed"
            >
            ...
            {/* Server Settings content - NOT ACCESSIBLE (under development) */}
          </div>
